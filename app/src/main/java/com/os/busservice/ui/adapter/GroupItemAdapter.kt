...
class GroupItemAdapter(var mCartListener: CommonListener) : RecyclerBaseAdapter() {

    var mList = ArrayList<String>()
    var mPos = 0

    override fun getLayoutIdForPosition(position: Int) = R.layout.group_item

    override fun putViewDataBinding(binding: ViewDataBinding) {
        if (binding is GroupItemBinding) {
