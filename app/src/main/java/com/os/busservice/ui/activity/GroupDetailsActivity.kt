...
import com.os.busservice.databinding.GroupDetailsActivityBinding
...
import com.os.busservice.ui.adapter.GroupDetailsAdapter
import com.os.busservice.ui.baseFile.BaseBindingActivity
import kotlinx.android.synthetic.main.main_toolbar_layout.*

class GroupDetailsActivity : BaseBindingActivity(), OnMapReadyCallback, GoogleMap.OnCameraMoveListener,GoogleMap.OnCameraIdleListener,CommonListener {

    private var mMap: GoogleMap? = null
    private var mBinding: GroupDetailsActivityBinding?=null
    private lateinit var mAdapter: GroupDetailsAdapter


    override fun setBinding() {
     mBinding= DataBindingUtil.setContentView(this,R.layout.group_details_activity)
    }

    override fun createActivityObject() {
        mAdapter = GroupDetailsAdapter(this)
